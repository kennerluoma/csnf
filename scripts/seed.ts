        ...
        cards: [
          {
            ...
            _type: 'card',
            title: 'Hero',
            body: 'Eyebrow, heading, body, CTA, image.',
          },
          {
            _key: 'b',
            _type: 'card',
            title: 'Rich text',
            body: 'Portable Text with an optional heading.',
          },
          {
            _key: 'c',
            _type: 'card',
            title: 'Card grid',
            body: 'A repeated component instance becomes an array.',
          },
        ],
      },
      {
            ...
            children: [
              {
                ...
                _type: 'span',
                marks: [],
                text: 'Every block is a Sanity object type plus a React component, registered once.',
              },
            ],
          },
        ],
