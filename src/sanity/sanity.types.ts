...
// Query: *[_type == "page" && slug.current == $slug][0]{  _id, title, "slug": slug.current, blocks[]{ _key, _type, _type == "artistList" => { eyebrow, heading, columns },  _type == "artworkGrid" => { eyebrow, heading, intro, columns, collection, limit, featuredOnly, showFilters, cta },  _type == "cardGrid" => { eyebrow, heading, columns, cards[]{ _key, title, body, image, link } },  _type == "contactForm" => { eyebrow, heading, intro, showSubject, buttonLabel, successMessage, aside },  _type == "eventCalendar" => { eyebrow, heading, view, limit, showFilters, cta },  _type == "exhibitionList" => { eyebrow, heading, mode, pastLimit, cta },  _type == "hero" => { layout, eyebrow, heading, body, cta, image },  _type == "newsletterSignup" => { eyebrow, heading, body, buttonLabel, tone },  _type == "postList" => { eyebrow, heading, limit, columns, cta },  _type == "richTextBlock" => { heading, content } }, seo{ title, description, image, noIndex }}
...
// Query: *[_type == "post" && slug.current == $slug][0]{ _id, title, "slug": slug.current, date, excerpt, "image": image{ _type, asset, alt, caption, hotspot, crop, "meta": asset->metadata{ lqip, "width": dimensions.width, "height": dimensions.height } }, tags, body, seo{ title, description, image, noIndex } }
...
// Query: *[_type == "siteSettings"][0]{  siteName, logo, nav[]{label, href}, footerText, social[]{label, href}, analyticsId,  seo{ title, description, image, noIndex }, contactEmail, newsletter{provider, actionUrl}}
...
declare global {
  interface SanityQueries {
    ...
    '*[_type == "event" && slug.current == $slug][0]{ _id, title, "slug": slug.current, start, end, allDay, location, venue->{ _id, name, "slug": slug.current, address, mapLink }, price, "image": image{ _type, asset, alt, caption, hotspot, crop, "meta": asset->metadata{ lqip, "width": dimensions.width, "height": dimensions.height } }, series->{ _id, title, "slug": slug.current }, ticketUrl, body, seo{ title, description, image, noIndex } }': EventBySlugQueryResult
    ...
    '*[_type == "post" && slug.current == $slug][0]{ _id, title, "slug": slug.current, date, excerpt, "image": image{ _type, asset, alt, caption, hotspot, crop, "meta": asset->metadata{ lqip, "width": dimensions.width, "height": dimensions.height } }, tags, body, seo{ title, description, image, noIndex } }': PostBySlugQueryResult
